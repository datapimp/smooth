(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["client"] = factory(require("jQuery"));
	else
		root["Smooth"] = root["Smooth"] || {}, root["Smooth"]["client"] = factory(root["jQuery"]);
...
/******/ 	__webpack_require__.p = "/smooth-developer-tools/";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	Smooth = {
	  ...
	  Resource: __webpack_require__(5)
	};

	Smooth.resource = Smooth.Resource.define;

	Smooth.configure = function(options) {
	  return _.extend(Smooth.config, options);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	util.classify = function(string, forceSingular) {
	  var classified;
	  if (forceSingular == null) {
	    forceSingular = true;
	  }
	  if (forceSingular) {
	    string = util.singularize(string);
	  }
	  classified = util.string.capitalize(util.string.camelize(string));
	  return classified;
	};

	util.resolve = function(string, root) {
	  var parts;
	  parts = string.split('.');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Collection = Backbone.Collection.extend({
	  initialize: function(models, options) {
	    ...
	    if (this.bootstrap && (typeof window !== "undefined" && window !== null ? (_ref = window.BootstrappedCollections) != null ? _ref[this.boostrap] : void 0 : void 0)) {
	      models = window.BootstrappedCollections[this.bootstrap];
	    }
	    return Backbone.Collection.prototype.initialize.apply(this, arguments);
	  },
	  inChunksOf: function(size) {
	    return util.chunk(this.models, size);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Resource = (function() {
	  ...
	  Resource.prototype.getModelClass = function() {
	    return this.definition.modelClass;
	  };

	  Resource.prototype.newModel = function(attributes, options) {
	    if (attributes == null) {
	      attributes = {};
	    }
	    if (options == null) {
	  ...
	  Resource.prototype.newCollection = function(models, options) {
	    if (models == null) {
	      models = [];
	    }
	    if (options == null) {
	    ...
	    return new this.definition.collectionClass(models, options);
	  };
	...
	_.extend(Resource, {
	  define: function(resourceName, options, fn) {
	    var definition;
	    if (options == null) {
	      options = {};
	    }
	    ...
	    definition = definitions[resourceName] || (definitions[resourceName] = new ResourceDefinition(resourceName, options));
	    if (fn != null) {
	...
	ModelDslAdapter = (function() {
	  function ModelDslAdapter(definition) {
	    if (definition == null) {
	      definition = {};
	    }
	  ...
	  ModelDslAdapter.prototype.url = function(url) {
	    return this.definition.url = url;
	  };

	  ModelDslAdapter.prototype["public"] = function(extensions) {
	    return _.extend(this.definition, extensions);
	  };

	  ModelDslAdapter.prototype["private"] = function(extensions) {
	    return _.extend(this.definition, extensions);
	  };
	  ...
	  return ModelDslAdapter;

	})();

	CollectionDslAdapter = (function(_super) {
	  __extends(CollectionDslAdapter, _super);

	  function CollectionDslAdapter() {
	    return CollectionDslAdapter.__super__.constructor.apply(this, arguments);
	  }

	  CollectionDslAdapter.prototype.name = "CollectionDslAdapter";

	  return CollectionDslAdapter;

	})(ModelDslAdapter);

	ResourceDefinition = (function() {
	  function ResourceDefinition(resourceName, options) {
	    if (options == null) {
	      options = {};
	    }
	    this.resourceName = resourceName;
	    this.options = options;
	    this._collection_interface = {
	      "public": [],
	      "private": []
	    };
	    this._model_interface = {
	      "public": [],
	      "private": []
	    };
	    this._collection_definition = {};
	    this._model_definition = {};
	    this.model = new ModelDslAdapter(this._model_definition);
	    this.collection = new CollectionDslAdapter(this._collection_definition);
	  }

	  ResourceDefinition.prototype.build = function() {
	    this.defineModelClass();
	    this.defineCollectionClass();
	    return new Resource({
	      definition: this
	    });
	  };

	  ResourceDefinition.prototype.defineModelClass = function() {
	    return this.modelClass || (this.modelClass = Model.extend(this.model.definition || {}));
	  };

	  ResourceDefinition.prototype.defineCollectionClass = function() {
	    var definition;
	    definition = this.collection.definition || {};
	    definition.model = this.modelClass || this.defineModelClass();
	    return this.collectionClass = Collection.extend(definition);
	  };
